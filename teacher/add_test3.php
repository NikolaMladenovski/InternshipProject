<?php
	...
	mysqli_query($mysqli,"insert into testovi (predmet_id,prof_id,godina,data,ispit_id, format) values ('$pred','$session_id','$uchebna_godina','$data','$ispit', '$format[$i]')")or die(mysqli_error($mysqli));
