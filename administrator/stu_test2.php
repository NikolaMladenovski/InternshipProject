                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table" >
                                ...
                                <tbody>
                                  <?php 
                                    ...
                                    <td width="20">
												<input class="uniform_on" name="poeni[]" type="number_format" value="<?php echo $null; ?>">
												<input type="hidden" id="inputEmail" name="id[]" value="<?php echo $id;  ?>" placeholder="id" required>
